...
public class Office {
    ...
    private String isThreeFranchisee;

    private Long crm_parentid;
    ...
    public void setParent_names(String parent_names) {
        this.parent_names = parent_names == null ? null : parent_names.trim();
    }
    ...
    public String getIsThreeFranchisee() {
        return isThreeFranchisee;
    }

    public void setIsThreeFranchisee(String isThreeFranchisee) {
        this.isThreeFranchisee = isThreeFranchisee == null ? null : isThreeFranchisee.trim();
    }

    public Long getCrm_parentid() {
        return crm_parentid;
    }

    public void setCrm_parentid(Long crm_parentid) {
        this.crm_parentid = crm_parentid;
    }
